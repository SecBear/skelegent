...
- No portable durable run/control surface is implemented in this branch yet.

Still required:

- end-to-end examples exercising orchestration graph wiring
- a durable run/control surface above Layer 0 that preserves backend freedom over replay/checkpoint/journal internals
