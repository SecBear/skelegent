...
**Decision:** The architecture has six protocol traits (`Operator`, `Dispatcher`, `Signalable`, `Queryable`, `StateStore`, `Environment`) and one cross-cutting interface family (per-boundary middleware).
