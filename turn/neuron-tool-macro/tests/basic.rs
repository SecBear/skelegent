// Integration tests for the `#[neuron_tool]` proc macro.
...
#[neuron_tool(name = "get_weather", description = "Get current weather")]
...
#[neuron_tool(name = "search", description = "Search for things")]
...
#[neuron_tool(name = "ping", description = "Ping the tool")]
