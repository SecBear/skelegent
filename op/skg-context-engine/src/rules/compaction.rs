...
//!
//! ```ignore
//! use skg_context_engine::rules::CompactionRule;
//!
...
//!
//! ```ignore
//! use skg_context_engine::ops::Compact;
//! use skg_context_engine::rules::compaction::{sliding_window, policy_trim};
//! use skg_context_engine::rules::{SummarizeConfig};
//!
...
///
/// ```ignore
/// use skg_context_engine::{ops::compact::Compact, rules::compaction::sliding_window};
///
