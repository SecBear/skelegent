...
//! [`infer_stream_fallback()`](neuron_turn::stream::infer_stream_fallback)
...
mod tests {
    ...
    impl neuron_turn::provider::Provider for FallbackStreamProvider {
        fn infer(
            &self,
            request: neuron_turn::InferRequest,
        ) -> impl std::future::Future<
            Output = Result<neuron_turn::InferResponse, neuron_turn::ProviderError>,
        > + Send {
